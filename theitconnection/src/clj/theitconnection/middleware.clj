(ns theitconnection.middleware
  (:require [theitconnection.env :refer [defaults]]
            [cheshire.generate :as cheshire]
            [cognitect.transit :as transit]
            [clojure.tools.logging :as log]
            [theitconnection.layout :refer [*app-context* error-page]]
            ...
            [theitconnection.config :refer [env]]
